...
generated_at: "2026-08-05T05:24:17.760799+00:00"
...
faq: [{"question": "Does homeowners insurance cover a flooded basement after heavy rain?", "answer": "Generally, no \u2014 not if the water entered from outside the home. Standard homeowners policies exclude flooding, which insurers define as water that originates from the ground or from surface runoff, not from a plumbing failure inside the house. Coverage for this type of event requires a separate flood insurance policy through the NFIP or a private flood carrier. If the basement flooded because an interior drain backed up, a sewer backup endorsement (if you have one) may apply instead."}, {"question": "My insurance adjuster says the damage is from a 'slow leak' and is denying my claim. What can I do?", "answer": "First, request the denial in writing and ask for the specific policy language they're relying on. If you believe the leak was genuinely sudden and you simply didn't notice it, gather any evidence that supports that timeline \u2014 recent plumbing inspections, the age of the supply line, photos showing no prior staining. You can file a formal dispute with your insurer, and if that doesn't resolve it, a licensed public adjuster works on your behalf (for a percentage of the settlement) to negotiate with the carrier. Your state's department of insurance also accepts complaints if you believe a denial was improper."}, {"question": "Will filing a water damage claim raise my homeowners insurance premium?", "answer": "It can, though the impact varies by insurer, your claims history, and the size of the claim. Many carriers track claims through a shared database called CLUE (Comprehensive Loss Underwriting Exchange), so even a claim you file and later withdraw may appear on your record. For smaller losses \u2014 say, under your deductible or only slightly above it \u2014 it sometimes makes financial sense to pay out of pocket rather than risk a premium increase or non-renewal. Talk to your agent about the likely impact before you decide whether to file."}, {"question": "How long does a water damage insurance claim typically take to resolve?", "answer": "Simple, well-documented claims with clear coverage can move through in a few weeks. Complex claims \u2014 large losses, coverage disputes, structural damage requiring multiple contractor estimates, or mold involvement \u2014 can stretch to several months. The single biggest factor you can control is documentation: detailed photos and video taken immediately, written records of every conversation with your adjuster, and a clear scope of work from your restoration contractor. Gaps in documentation are the most common reason straightforward claims slow down."}]
...
1. **Coverage A (Dwelling)**, this is what pays to repair the structure of your home: walls, floors, ceilings, built-in appliances.
2. **Coverage C (Personal Property)**, this covers your belongings. Check whether it's replacement cost value (what it costs to buy new) or actual cash value (depreciated). The difference matters enormously when you're replacing a five-year-old sofa.
3. **Exclusions section**, search specifically for the words *flood*, *seepage*, *groundwater*, *gradual*, and *neglect*. These are the words that will appear in a denial letter.
...
1. **Stop the source if you can.** For a burst pipe, locate your main water shutoff, typically near the water meter, often in a utility room or crawl space, and turn it off. For an appliance failure, shut off the supply valve behind or beneath the unit.
2. **Call your insurance company or agent.** Report the loss promptly. Most policies require timely notice, and waiting can complicate your claim. You don't need to know the full extent of damage yet, just report that a loss occurred.
3. **Document before you touch anything.** Walk through with your phone and take video of every affected room. Open closets, pull back rugs, photograph ceilings and walls. Adjusters work from documentation; the more you capture, the stronger your claim.
...
5. **Do not discard damaged materials until the adjuster has seen them**, or until you have photographed them thoroughly. Torn-out wet drywall that's already in a dumpster is harder to document for a claim.
